...
let me = {
    firstName: 'Jason',
    superHeroName: 'Red Power Ranger',
    homeTown: 'Angel Grove',  
    superPowers: ['Martial Arts', 'Super Strength', 'Awesome Friend'],
    superPowerXP: function(){Math.floor(Math.random()*10)+1},
    profileImage: function(){https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg}
        }
